/*:
 * @plugindesc (v.0.7.6)[PRO] Multiplayer for RPG Maker
...
var ANET = {};
ANET.Version = 76; // 0.7.6

ANET.MinServerRev = 114; // * Необходимая ревизия сервера

// * このシンボルは、1_DevSymbol_TESTではdevとして上書きされます。
...
//Plugin KDCore builded by PKD PluginBuilder 2.1 - 18.04.2022
...
(function() {
  ...
  _.roomChatSendMessageButtonClick = function() {};
  // * PRIVATE  ======================================================
  _._loadCSS = function() {
    var head;
  ...
  /*head.insertAdjacentHTML(
      ...
      <link rel=\"stylesheet\" href=\"css/anet_chat.css\" />"
  )*/
  ...
  _._createInputField = function(placeholder) {
    ...
    length = ANET.PP.getTextInputMaxLength();
    htmlCode = "<input type=\"input\" class=\"form__field\" placeholder=\"" + placeholder + "\" autocomplete=\"off\" maxlength=\"" + length + "\" name=\"anetInputName\" id='anetInputName' required /> <label for=\"anetInputName\" class=\"form__label\">" + placeholder + "</label>";
    this._input.insertAdjacentHTML('beforeend', htmlCode);
    this._canvasRelativeElements.appendChild(this._input);
  };
  _._createRoomChat = function() {
    var htmlCode;
    htmlCode = "<section class=\"msger\"> <header class=\"msger-header\"> <div class=\"msger-header-title\"> <strong>Alpha NETZ</strong> players on server chat </div> </header> <main class=\"msger-chat\"> <div class=\"msg-bubble\"> <div class=\"msg-info\"> <div class=\"msg-info-name\">Pheonix KageDesu</div> <div class=\"msg-info-time\">[Author]</div> </div> <div class=\"msg-text\"> Welcome to Alpha NET Z 😄 This chat in PREVIEW mode, just for testing... </div> </div> </div> <div class=\"msg right-msg\"> <div class=\"msg-bubble\"> <div class=\"msg-info\"> <div class=\"msg-info-name\">Player 432</div> <div class=\"msg-info-time\">12:46</div> </div> <div class=\"msg-text\"> Very cool 👍 </div> </div> </div> </main> <div class=\"msger-inputarea\"> <input type=\"text\" class=\"msger-input\" placeholder=\"Enter your message...\"> <button onClick=\"sss()\" class=\"msger-send-btn\">Send</button> </div> </section>";
    //https://codepen.io/sajadhsm/pen/odaBdd
    //TODO: кнопка скрыть (открыть чат) через класс translate и transition
    //TODO: Методы отправки сообщений (через сервер тоже)
    //TODO: Параметр и отрегулировать высоту окна со списком комнат
...
(function() {  //window.sss = () -> console.log('123')
...
// Generated by CoffeeScript 2.6.1
// * 基本インターフェースマネージャークラス (API)
// * クラスと同様 AA.UI из ABSZ
ANET.UI = function() {};
...
(function() {  //╒═════════════════════════════════════════════════════════════════════════╛
  ...
  (function() {    
    ...
    // * カーソルクリックを処理するUI要素があれば、trueを返します
  ...
  (function() {    // -----------------------------------------------------------------------
    ...
    // * オプションでBasicにはないため、プレイヤーメニュー（作成済み）はあるのか
...
(function() {  //╒═════════════════════════════════════════════════════════════════════════╛
  ...
  _._prepareConnectionSettings = function() {
    ...
    // * ここでは基本的に不要です（基本版には独自のメソッドがあるため）。
  ...
  _._prepareLocaleValues = function() {
    var p;
    // * 重複を避けるため、ここでは{}の空白を使用します
    p = this.getParam("localeDB", {});
    // * Default値で値を埋める
    // * これは、新しいものが追加されたときに、ユーザーがまだ持っていない可能性があるためです
    this._localeDB = {
...
// Generated by CoffeeScript 2.6.1
// * 基本的なScene_Item（アイテム選択）シーンを使用しています
...
//Plugin Alpha_NETZ builded by PKD PluginBuilder 2.1 - 18.04.2022